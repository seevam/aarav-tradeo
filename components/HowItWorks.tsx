export default function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="py-20 lg:py-32 bg-[--color-light]">
      <div className="container mx-auto px-6">
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center space-x-2 bg-[--color-primary-light]/30 rounded-full px-4 py-2 mb-6">
            <span className="text-[--color-primary] font-medium text-sm">📍 Your Journey</span>
          </div>
            ...
            {steps.map((step, index) => (
              <div key={index} className="relative">
                ...
                {index < steps.length - 1 && (
                  <div className="hidden lg:block absolute top-12 left-full w-full h-0.5 bg-gradient-to-r from-[--color-primary] to-transparent -ml-4 z-0"
                ...
                <div className="relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow z-10">
                  {/* Step Number Badge */}
                  <div className="absolute -top-4 -left-4 w-12 h-12 bg-[--color-primary] rounded-full flex items-center justify-center text-white font-bold text-xl shadow-lg">
                    {step.number}
                  </div>
        ...
        <div className="mt-20 bg-white rounded-3xl p-12 shadow-lg">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-4xl font-bold text-[--color-primary] mb-2">5-10 min</div>
              <div className="text-[--color-gray]">Per lesson</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-[--color-primary] mb-2">$100K</div>
              <div className="text-[--color-gray]">Virtual capital</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-[--color-primary] mb-2">24/7</div>
              <div className="text-[--color-gray]">AI assistance</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-[--color-primary] mb-2">0</div>
              <div className="text-[--color-gray]">Financial risk</div>
            </div>
          </div>
        </div>
      </div>
