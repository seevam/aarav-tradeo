        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#features" className="text-white/70 hover:text-primary transition-colors">Features</a></li>
              ...
              <li><a href="#" className="text-white/70 hover:text-primary transition-colors">Roadmap</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-white/70 hover:text-primary transition-colors">Press Kit</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-white/70 hover:text-primary transition-colors">Disclaimer</a></li>
              <li><a href="#" className="text-white/70 hover:text-primary transition-colors">Licenses</a></li>
            </ul>
          </div>
        </div>
